...
export default function SaveButton({ videoId }: { videoId: string }) {
  ...
  return (
    <>
      ...
      >
        <FolderPlus className="mr-2 h-5 w-5 shrink-0 stroke-neutral-300" />
        Save
      </Button>
      {/* 1 End  */}
        ...
        <Dialog as="div" className="relative z-10 " onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className=" relative m-2 flex !max-w-xs transform flex-col items-start justify-start overflow-hidden rounded-lg bg-neutral-700 px-4 pb-4 pt-5 text-center shadow-xl transition-all sm:my-8 sm:w-full  sm:p-6">
                  <div className="absolute right-0 top-0  hidden pr-4 pt-4 sm:block">
                    <button
                      type="button"
                      className="rounded-md bg-neutral-700 text-neutral-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
                        ...
                        <div className="relative flex items-start justify-start text-left">
                          ...
                          <div className="flex h-6 items-center">
                            <input
                              ...
                              className="h-4 w-4 rounded border-gray-300 text-neutral-100 bg-neutral-700"
                            />
                          </div>
                          {/* 7 start End */}
                          {/* 5 skip stop */}
                    ...
                    <div>
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          className="block w-full rounded-md border py-1.5 text-neutral-100 shadow-sm placeholder:text-gray-400 sm:text-sm sm:leading-6 bg-neutral-700 border-neutral-500"
