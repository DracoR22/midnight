        ...
        >
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-neutral-900 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                  {/* ! step 1 End */}
                  {/* step 2 start */}
                  {currentPage === 1 && (
                    <>
                            ...
                            <div className="mt-2 flex justify-center rounded-lg border border-dashed border-neutral-600 px-6 py-10">
                              <div className="text-center">
                                {croppedImage ? (
                                  ...
                                  <>
                                    <div className="mt-4 flex text-sm leading-6 text-neutral-300">
                                      <label
                                        htmlFor="file-upload"
                                        className="relative cursor-pointer rounded-md bg-neutral-700 font-semibold text-white focus-within:outline-none focus-within:ring-2 focus-within:ring-primary-600 focus-within:ring-offset-2 hover:text-neutral-300"
                                      >
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <div className="mt-2">
                              <input
                                ...
                                value={user.title}
                                className="block w-full rounded-md border-0 py-1.5 text-neutral-100 shadow-sm ring-1 ring-inset ring-neutral-600 bg-neutral-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
                              />
                            </div>
                            ...
                            <div className="mt-2">
                              <textarea
                                ...
                                onChange={handleInputChange}
                                className="block w-full rounded-md border-0 p-4 py-1.5 text-neutral-100 shadow-sm ring-1 ring-inset ring-neutral-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset bg-neutral-700 focus:ring-neutral-600sm:text-sm sm:leading-6"
                              />
                            </div>
                          </div>
                        </div>
