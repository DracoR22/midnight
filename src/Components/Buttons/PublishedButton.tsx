  ...
  return (
    <>
      <td className="whitespace-nowrap px-3 py-5 text-sm text-neutral-300">
        <Switch
          ...
          className={classNames(
            userChoice.publish ? "bg-neutral-300" : "bg-neutral-300",
        ...
        >
          ...
          <span
            ...
            className={classNames(
              ...
              "pointer-events-none inline-block h-5 w-5 transform rounded-full bg-neutral-700 shadow ring-0 transition duration-200 ease-in-out"
            )}
          />
        </Switch>
      </td>
      <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
        {userChoice.publish ? (
          <span className="inline-flex items-center rounded-full border  border-success-500 px-2 py-1 text-xs font-medium text-success-500">
            Published
          </span>
        ) : (
          <span className="inline-flex items-center rounded-full border  border-warning-500 px-2 py-1 text-xs font-medium text-warning-500">
            Unpublished
          </span>
        )}
      </td>
