      ...
      <Layout>
        <>
              ...
              <div className=" relative mt-2 flex flex-row gap-2">
                <div className="w-full">
                  <textarea
                    ...
                    className="block bg-neutral-700 w-full rounded-md border-0 p-4 py-1.5 text-neutral-100 shadow-sm ring-1 ring-inset ring-neutral-700 placeholder:text-neutral-300 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
                ...
                <div className="flex-shrink-0">
                  <button
                    type="submit"
                    className="inline-flex items-center rounded-md bg-neutral-700 hover:bg-neutral-600 px-3 py-2 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
                  >
                    Post
                  </button>
                </div>
          ...
          {errorTypes ? (
            ...
            <ul role="list" className="-pt-8 divide-y divide-neutral-700">
              {announcements
                ?.sort(
                  (a, b) =>
                        ...
                        <div className="flex w-full flex-col ">
                          <div className="flex flex-col">
                            <div className="flex flex-row items-start gap-2 text-xs">
                              <p className="w-max text-sm font-semibold leading-6 text-neutral-100">
                                {user.name}
                              </p>
