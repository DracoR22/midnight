...
import { LoadingMessage } from "~/Components/ErrorMessage";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Settings for Midnight" />
      ...
      <Layout closeSidebar={false}>
        <>
          ...
          <div className="space-y-10 divide-y divide-neutral-700">
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
              ...
              <form className="bg-neutral-700 shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                    ...
                    <div className="sm:col-span-3">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          className="block w-full rounded-md border-0 py-1.5 text-neutral-100 shadow-sm bg-neutral-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 sm:text-sm sm:leading-6"
                        />
                      </div>
                    </div>
                    ...
                    <div className="sm:col-span-4">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          value={user.email || ""}
                          onChange={handleInputChange}
                          className="block w-full rounded-md border-0 py-1.5 text-neutral-100 shadow-sm placeholder:text-gray-400 sm:text-sm sm:leading-6 bg-neutral-600"
                        />
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="sm:col-span-4">
                      ...
                      <div className="mt-2">
                        <div className="flex rounded-md shadow-sm sm:max-w-md">
                          <span className="flex select-none items-center pl-3 text-neutral-300 sm:text-sm">
                            midnight .com/
                          </span>
                          <input
                            type="text"
                            name="handle"
                            id="handle"
                            className="block flex-1 border-0 py-1.5 pl-1 text-neutral-100 placeholder:text-gray-400 sm:text-sm sm:leading-6 bg-neutral-600"
                            value={user.handle || ""}
                            onChange={handleInputChange}
                          />
                        </div>
                    ...
                    <div className="col-span-full">
                      ...
                      <div className="mt-2">
                        <textarea
                          ...
                          name="description"
                          rows={3}
                          className="block w-full border-0 rounded-md py-1.5 text-neutral-100 shadow-sm placeholder:text-gray-400 bg-neutral-600 sm:text-sm sm:leading-6"
        ...
        <Dialog as="div" className="relative z-10" onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-neutral-700 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                  <>
                    <ImageCropper
